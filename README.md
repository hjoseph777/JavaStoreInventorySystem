...
<div align="center">
<!-- 
This diagram uses Mermaid.js syntax (https://mermaid.js.org/)
If the diagram doesn't render properly, visit the Mermaid Live Editor:
https://mermaid.live/
-->
...
classDiagram
    ...
    %% Add notes to highlight mode-switching methods
    note for AppLauncher "Mode Switching Methods:\n+launchConsoleMode() - Terminal\n+launchGUIMode() - JavaFX\n+requestConsoleMode() - Switch"
```

</div>

<!-- If diagram isn't visible above, see it at: https://mermaid.live/ -->
